...
| `retrieve` | 200 | Y | id=chatcmpl-837156a46549f2c5 |
| `continue_flow` | 200 | Y | prev=chatcmpl-837156a46549f2c5 |
...
- `datasets/responsesapi-01/runs/run-20260826-172323-responsesapi/results.json` — raw rows
- `datasets/responsesapi-01/runs/run-20260826-172323-responsesapi/eval.json` — pass/fail summary
- `datasets/responsesapi-01/runs/run-20260826-172323-responsesapi/report.md` — this report
- latest copies: `datasets/responsesapi-01/results.json`, `eval.json`

---

*Rendered by `smoketests/responsesapi-01/report.py` at 2026-08-26T17:23:25+0200.*
