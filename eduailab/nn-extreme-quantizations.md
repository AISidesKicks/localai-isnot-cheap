...
## Qwen3.8-27B deep dive
 ...
 - [Qwen3.8 27B GGUF Benchmark: Q4 to Q1 Accuracy and Token Efficiency (15 GGUFs, 150M+ tokens)](https://kaitchup.substack.com/p/qwen38-27b-gguf-benchmark-q4-to-q1)
 - [Qwen3.8 27B Reasoning Benchmarks: Off vs Low vs Medium vs Xhigh](https://kaitchup.substack.com/p/qwen38-27b-reasoning-benchmarks-off)
 - [Qwen3.8 27B is excellent, but it defaults to wildly overthinking things](https://simonw.substack.com/p/qwen-38-27b-is-excellent-but-it-defaults)

## Qwen3.8-27B in EDU AI LAB
